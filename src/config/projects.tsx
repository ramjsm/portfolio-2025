...
export const projectsList: Project[] = [
  ...
  },
  {
    ...
    intro: (
      <>
        <p>
          Soberanía Creativa is a platform dedicated to somatic-spiritual
          healing through creative expression.
        </p>
        <p>
          Designed and implemented in WordPress, the site was envisioned as a
          digital oasis for reading and learning. It offers a familiar space
          that invites reflection and exploration.
        </p>
        <p>
          It reflects the vision of Paloma Todd Montes, an artist and
          facilitator whose work arises from a personal landscape of exile,
          hybridity, and embodied memory. The site showcases her illustrations,
          portfolio, blog, and podcast, offering a window into her creative
          world.
        </p>
        <p>
  ...
  },
  {
    ...
    intro: (
      <>
        <p>
          Irma Joanne is an interdisciplinary artist based in Rotterdam. Her
          work focuses on the human body and how we experience it through both
        ...
        <p>
          By freezing the body in material and layering it with moving images,
          she explores how people react to their own physical form.
        </p>
      </>
    ),
    info: [
