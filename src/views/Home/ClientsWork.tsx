        ...
        <div className="relative w-full justify-center mt-100">
                ...
                <div className="clients-work-header relative h-50 z-10">
                    <div className="absolute right-0 top-10">
                        <div className="client-work-shadow font-syne text-8xl text-transparent text-stroke-gray-100 text-stroke-1 mr-40">CLIENTS</div>
                        <div className="client-work-shadow font-syne text-right text-8xl text-transparent text-stroke-gray-100 text-stroke-1">WORK</div>
                    </div>
                ...
                <div className="flex flex-col gap-4 w-[80%] mx-auto">
                    {projects.map((project) => (
                        <Link to="/project/soberania-creativa" className="border-texture relative w-full h-1/2 aspect-video">
                            <WebGLImageWrapper {...project.thumbnail} />
                            <span id={project.slug} className={`absolute text-l text-white text-l font-pp-neue-montreal uppercase ${project.thumbnail.labelClass}`}>{`/${project.title}`}</span>
                        </Link>
                    ))}
                </div>
        </div>
